...
export default function Leaderboard() {
    ...
    return <div className="w-full h-full p-8 flex gap-8 items-start justify-center overflow-clip">
        <div className="rank-cards-container no-scroll w-full lg:w-1/3 h-[100%] flex flex-col items-center overflow-auto gap-4">
            ...
            {leaderboard && leaderboard.users.map((user, index) => {
                ...
                return <div key={index} className={`w-full max-w-[500px] relative border flex items-center px-8 py-[18px] gap-4 ${rank > 3 ? "border-orange-0" : "border-yellow-0 floor"}`}>
                    ...
                    <div className="flex w-full gap-2">
                        <div className="flex flex-col ml-auto 2xl:px-4">
