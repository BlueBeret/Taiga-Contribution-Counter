            ...
            <div className="flex flex-col w-100 gap-8">
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-1 border border-purple-0 bg-purple-50 px-2 py-[10px] rounded-[4px]">
                        {HostIcon}
                        <input className="bg-transparent" placeholder="Hostname" title="example: http://10.10.10.1:9000" type="text" value={hostname} onChange={e => setHostname(e.target.value)}></input>
                    </div>
                    <div className="flex items-center gap-1 border border-purple-0 bg-purple-50 px-2 py-[10px] rounded-[4px]">
                        {UserIcon}
...
const UserIcon = <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_15_11)">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M9.99999 10.8333C11.6108 10.8333 12.9167 9.52749 12.9167 7.91666C12.9167 6.30583 11.6108 4.99999 9.99999 4.99999C8.38916 4.99999 7.08332 6.30583 7.08332 7.91666C7.08332 9.52749 8.38916 10.8333 9.99999 10.8333ZM9.99999 9.58332C10.9205 9.58332 11.6667 8.83713 11.6667 7.91666C11.6667 6.99618 10.9205 6.24999 9.99999 6.24999C9.07952 6.24999 8.33332 6.99618 8.33332 7.91666C8.33332 8.83713 9.07952 9.58332 9.99999 9.58332Z" fill="white" />
...
const HostIcon = <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clip-path="url(#clip0_2_366)">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M3 15C3 13.8954 3.89543 13 5 13H9C10.1046 13 11 13.8954 11 15V19C11 20.1046 10.1046 21 9 21H5C3.89543 21 3 20.1046 3 19V15ZM5 15H9V19H5V15Z" fill="white" />
        <path fill-rule="evenodd" clip-rule="evenodd" d="M15 3C13.8954 3 13 3.89543 13 5V9C13 10.1046 13.8954 11 15 11H19C20.1046 11 21 10.1046 21 9V5C21 3.89543 20.1046 3 19 3H15ZM19 5H15V9H19V5Z" fill="white" />
        <path fill-rule="evenodd" clip-rule="evenodd" d="M13 15C13 13.8954 13.8954 13 15 13H19C20.1046 13 21 13.8954 21 15V19C21 20.1046 20.1046 21 19 21H15C13.8954 21 13 20.1046 13 19V15ZM15 15H19V19H15V15Z" fill="white" />
    </g>
    <defs>
